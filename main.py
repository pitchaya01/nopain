...
import os
#usernames = ["club_wmtx"]
usernames = ["siamblockchain","BitcoinMagazine","IOHK_Charles","fairgatelabs","worldmobileteam", "MrTelecoms","CloverNodes","WMTxLady","hopenothype_io","wmchain","SebastienGllmt","MinswapIntern","ChristianRees"]
...
def is_token_price_related(text):
    ...
    keywords = ["price","ล้าง","แตก","hold","hodl","ath","buy","mc","sold","ขาย","ซื้อ","bear"] 
    lowered = text.lower()

...
import openai
import os
usernames = ["siamblockchain","BitcoinMagazine","IOHK_Charles", "MrTelecoms","CloverNodes","WMTxLady","hopenothype_io","wmchain","SebastienGllmt","MinswapIntern","ChristianRees","SebastienGllmt"]
